...
@fig-regressao shows a set of points $(x_i, y_i)$ and the line fitted by
@eq-ols. The estimated intercept and slope are $\hat{\beta}_0 \approx 1.78$ and
$\hat{\beta}_1 \approx 0.79$, respectively.

![Regression line fitted by ordinary least squares. Source: prepared by the author (2026).](regressao-en.png){#fig-regressao width=75%}
